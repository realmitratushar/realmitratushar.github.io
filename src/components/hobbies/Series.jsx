        ...
        <HobbyPage title="The Comfort Zone" icon={MdTv}>
            <div className="mb-12">
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        {activeTab === 'completed' && <ShowGrid shows={seriesData.completed} />}
                        {activeTab === 'watching' && <ShowGrid shows={seriesData.watching} />}
                        {activeTab === 'watchlist' && <ShowGrid shows={seriesData.watchlist} />}
                    </motion.div>
                </AnimatePresence>
            </div>
        </HobbyPage>
